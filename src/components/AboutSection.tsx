    ...
    <section id="about-section" className="py-24 bg-white dark:bg-slate-950 transition-colors overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          {/* Left Column: Image with Organic Rounded Border & Trust Badge */}
          <div className="w-full lg:w-1/2 relative group">
            <div className="relative z-10 overflow-hidden shadow-2xl aspect-4/3 rounded-[2.5rem] bg-gray-100 dark:bg-slate-800">
              <img
                src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80"
                alt="Hardware and Construction Materials Warehouse"
