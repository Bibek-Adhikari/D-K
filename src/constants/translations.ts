  ...
  en: {
    ...
    hero: {
      ...
      points: [
        ...
        { title: 'Full Contractor Support', desc: 'Instant estimates, bulk discounts & customized orders.' },
  ...
  ne: {
    ...
    hero: {
      ...
      points: [
        ...
        { title: 'ठेकेदारहरूलाई विशेष सुविधा', desc: 'तत्काल इस्टिमेट, विशेष छुट र सहज अर्डर व्यवस्था।' },
